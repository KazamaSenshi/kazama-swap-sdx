import { ChainId, Currency, currencyEquals, JSBI, Price } from '@kazamaswap/sdk'
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
 ...
 export const useKazamaBusdPrice = (): Price | undefined => {
 const KazamaBusdPrice = useBUSDPrice(tokens.kazama)
