...
import {
  ...
  getErc721Contract,
  getKazamaVaultContract,
  getPredictionsContract,
  getChainlinkOracleContract,
  getSouschefV2Contract,
  getKazamaLotteryContract,
  getKazamaBNBLotteryContract,
  getKazamaFarmAuctionContract,
  getWBNBContract,
...
import { ChainId, WETH } from '@kazamaswap/sdk'
...
export const useKazama = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getKazamaContract(library.getSigner()), [library])
}
...
export const useKazamaLotteryContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getKazamaLotteryContract(library.getSigner()), [library])
}

export const useKazamaBNBLotteryContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getKazamaBNBLotteryContract(library.getSigner()), [library])
}

export const useSenshiMaster = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getSenshiMasterContract(library.getSigner()), [library])
}

export const useWrappedBNB = () => {
  const { library } = useActiveWeb3React()
...
export const useKazamaVaultContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getKazamaVaultContract(library.getSigner()), [library])
}
...
export const useKazamaFarmAuctionContract = () => {
  ...
  return useMemo(() => getKazamaFarmAuctionContract(account ? library.getSigner() : library), [library, account])
}
