...
import { AutoRenewIcon, Button, Card, CardBody, Flex, Skeleton, Text, Link, ArrowForwardIcon } from '@kazamaswap/uikit'
  ...
  const harvestAllFarms = useCallback(async () => {
    ...
    for (const farmWithBalance of farmsWithStakedBalance) {
      try {
        ...
        await harvestFarm(SenshiMasterContract, farmWithBalance.pid)
        toastSuccess(
          `${t('Harvested')}!`,
    ...
    setPendingTx(false)
  }, [farmsWithStakedBalance, SenshiMasterContract, toastSuccess, toastError, t])
