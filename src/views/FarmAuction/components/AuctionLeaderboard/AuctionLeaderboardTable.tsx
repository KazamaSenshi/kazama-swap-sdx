...
const GridCell = styled(Flex)<{ isTopPosition: boolean }>`
  ...
  ${({ theme, isTopPosition }) => isTopPosition && `background-color: #fff;`}
`
...
const LeaderboardRow: React.FC<LeaderboardRowProps> = ({ bidder, kazamaPriceBusd, isMobile }) => {
  ...
  if (totalBidders === 0) {
    return (
      <Flex justifyContent="center" alignItems="center" flexDirection="column" py="24px">
        ...
        <img src="/images/comeback.png" alt={t('Come back when the auctions started!')} />
      </Flex>
    )
  }
