...
import { Flex, Text, IconButton, AddIcon, MinusIcon, useModal, Skeleton } from '@kazamaswap/uikit'
...
const HasSharesActions: React.FC<HasStakeActionProps> = ({ pool, stakingTokenBalance, performanceFee }) => {
  ...
  const [onPresentUnstake] = useModal(<VaultStakeModal stakingMax={kazamaAsBigNumber} pool={pool} isRemovingStake />)
