...
const StakeModal: React.FC<StakeModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <Text ml="auto" color="textSubtle" fontSize="16px" mb="8px">
        {t('Balance: %balance%', {
          balance: getFullDisplayBalance(getCalculatedStakingLimit(), stakingToken.decimals, 2),
        })}
      </Text>
      <Flex alignItems="center" justifyContent="space-between" mt="8px">
        <PercentageButton onClick={() => handleChangePercent(10)}>10%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(20)}>20%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(30)}>30%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(40)}>40%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(50)}>50%</PercentageButton>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between" mt="8px">
        <PercentageButton onClick={() => handleChangePercent(60)}>60%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(70)}>70%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(80)}>80%</PercentageButton>
        <PercentageButton onClick={() => handleChangePercent(90)}>90%</PercentageButton>
      ...
      >
        <KazamaTextButton>
        {pendingTx ? t('Confirming') : t('Confirm stake')}
        </KazamaTextButton>
      </Button>
      {!isRemovingStake && (
        <StyledLink external href={getTokenLink}>
          <Button width="100%" mt="8px" variant="primary">
            <KazamaTextButton>
            {t('Need %symbol%?', { symbol: stakingToken.symbol })}
            </KazamaTextButton>
          </Button>
        </StyledLink>
      )}
