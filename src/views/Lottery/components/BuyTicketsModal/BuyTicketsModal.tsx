...
import { useKazama, useKazamaLotteryContract } from 'hooks/useContract'
...
const BuyTicketsModal: React.FC<BuyTicketsModalProps> = ({ onDismiss }) => {
  ...
  const lotteryContract = useKazamaLotteryContract()
  ...
  const { isApproving, isApproved, isConfirmed, isConfirming, handleApprove, handleConfirm } =
    useApproveConfirmTransaction({
      onRequiresApproval: async () => {
        try {
          const response = await kazamaContract.allowance(account, lotteryContract.address)
      ...
      onApprove: () => {
        return callWithGasPrice(kazamaContract, 'approve', [lotteryContract.address, ethers.constants.MaxUint256])
      },
