...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, KazamaDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | KazamaDayData): ChartEntry => ({
