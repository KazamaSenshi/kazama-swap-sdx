...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/kazamasenshi/blocks'
const STREAMING_FAST_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/kazamasenshi/kazama-swap-exchange'
